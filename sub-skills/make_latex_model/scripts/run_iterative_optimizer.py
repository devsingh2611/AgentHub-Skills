...
示例：
  python3 skills/make_latex_model/scripts/run_iterative_optimizer.py --project NSFC_Local --iteration 1 --mode heuristic
  python3 skills/make_latex_model/scripts/run_iterative_optimizer.py --project NSFC_Local --iteration 1 --mode manual_file
"""
...
from scripts.core.iterative_optimizer import AIOptimizer
